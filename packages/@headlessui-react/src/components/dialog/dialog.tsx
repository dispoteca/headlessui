...
>(
  ...
  let close = useEvent((event?: Event | SyntheticEvent) => onClose(false, event))
  ...
  focusTrapFeatures = focusTrapFeatures ?? FocusTrap.features.All & ~FocusTrap.features.FocusLock
